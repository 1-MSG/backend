...
import spharos.msg.domain.users.service.impl.v1.OAuthServiceImplV1;
...
@Tag(name = "OAuth V1", description = "간편 로그인 관련 API")
public class OAuthControllerV1 {

    private final OAuthServiceImplV1 oAuthService;
