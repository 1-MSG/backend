...
import spharos.msg.domain.admin.service.CountPriceServiceV1;
...
@Slf4j
@Tag(name = "Admin Orders V1", description = "어드민 주문 관련 페이지")
public class CountPriceControllerV1 {

    private final CountPriceServiceV1 countPriceService;
