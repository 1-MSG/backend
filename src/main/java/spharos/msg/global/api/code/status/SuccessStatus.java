...
public enum SuccessStatus implements BaseCode {
    ...
    CART_PRODUCT_UPDATE_SUCCESS(HttpStatus.OK, "CART200", "장바구니 수정 성공"),
    CART_PRODUCT_DELETE_SUCCESS(HttpStatus.OK, "CART200", "장바구니 삭제 성공"),
    CART_PRODUCT_OPTION_SUCCESS(HttpStatus.OK, "CART200", "장바구니 옵션 조회 성공"),
    ...
    COUPON_GET_USERS_SUCCESS(HttpStatus.OK, "COUPON200", "보유 쿠폰 목록 조회 성공"),
